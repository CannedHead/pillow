...
var dataVideos=[
	...
	{filename:"3",boxId:"slide3",color:"#353ff8",background:"#FFFFFF"},
	{filename:"5",boxId:"slide5",color:"#353ff8",background:"#FFFFFF"},
	{filename:"6",boxId:"slide6",color:"#D0AA00",background:"#FFFFFF"},
	{filename:"8",boxId:"slide8",color:"#D0AA00",background:"#FFFFFF"},		
	];
...
function loopVideo(){
	count++;
	for(var i=0;i<dataVideos.length;i++){
		var delay=(i+1)*3000;setTimeout("videoSlide("+i+");",delay);
	}
}
